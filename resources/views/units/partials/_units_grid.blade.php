    ...
    @forelse($units as $unit)
        @php
            ...
            $card_bg = match($unit->status) {
                'active'            => 'bg-white border-green-500 border-l-4 border-y border-r border-gray-200',
                'maintenance'       => 'bg-white border-red-500 border-l-4 border-y border-r border-gray-200',
                'coding'            => 'bg-white border-yellow-400 border-l-4 border-y border-r border-gray-200',
                'at_risk'           => 'bg-white border-orange-500 border-l-4 border-y border-r border-gray-200',
                'vacant', 'available' => 'bg-white border-blue-500 border-l-4 border-y border-r border-gray-200',
                default             => 'bg-white border-gray-300 border-l-4 border-y border-r border-gray-200',
            };
            // Driver section bg per status
            $driver_bg = match($unit->status) {
                'active'            => 'bg-gray-50 border-gray-100',
                'maintenance'       => 'bg-gray-50 border-gray-100',
                'coding'            => 'bg-gray-50 border-gray-100',
                'at_risk'           => 'bg-gray-50 border-gray-100',
                'vacant', 'available' => 'bg-gray-50 border-gray-100',
            ...
            $icon_bg = match($unit->status) {
                ...
                'coding'            => 'bg-yellow-50 border-yellow-100',
                'at_risk'           => 'bg-orange-50 border-orange-100',
                'vacant', 'available' => 'bg-blue-50 border-blue-100',
