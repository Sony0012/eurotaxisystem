...
<div id="tab-incentives">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-5">
        <div class="card-hover in-view wave-green cursor-default group relative overflow-hidden rounded-2xl shadow-sm border border-green-100 bg-gradient-to-br from-green-50 to-emerald-50/70">
