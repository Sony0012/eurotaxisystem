        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    ...
                    <form action="{{ route('archive.forceDelete', ['type' => 'driver', 'id' => $driver->id]) }}" method="POST" class="inline-block" onsubmit="return confirm('Are you sure you want to permanently delete this driver?')">
                        @csrf
                        @method('DELETE')
            ...
            @empty
            <tr>
                <td colspan="4" class="px-6 py-10 text-center text-gray-500">No archived drivers found.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
