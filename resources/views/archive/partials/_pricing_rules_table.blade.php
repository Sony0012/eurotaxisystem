            ...
            <tr class="hover:bg-slate-50/80 transition-colors">
                ...
                <td class="px-6 sm:px-8 py-5 whitespace-nowrap text-right">
                    <div class="flex items-center justify-end gap-2">
                        <button type="button"
                            onclick="archiveRestore('{{ route('archive.restore', ['type' => 'pricing_rule', 'id' => $item->id]) }}', this)"
                        ...
                        <button type="button"
                            onclick="archiveForceDelete('{{ route('archive.forceDelete', ['type' => 'pricing_rule', 'id' => $item->id]) }}', this)"
            ...
            <tr>
                <td colspan="4" class="px-6 sm:px-8 py-16 text-center">
                    <div class="flex flex-col items-center gap-3 text-slate-400">
                        ...
                        <p class="text-sm font-bold text-slate-700">No archived pricing rules found</p>
                        <p class="text-xs text-slate-400">Pricing and boundary calculation rules in archive will appear here.</p>
                    </div>
                </td>
            </tr>
            @endforelse
