            ...
            <tr class="hover:bg-slate-50/80 transition-colors group" data-id="{{ $item->id }}">
                ...
                <td class="px-6 sm:px-8 py-5 whitespace-nowrap text-right">
                    <div class="flex items-center justify-end gap-2">
                        <button type="button"
                            onclick="archiveRestore('{{ route('archive.restore', ['type' => 'spare_part', 'id' => $item->id]) }}', this)"
                        ...
                        <button type="button"
                            onclick="archiveForceDelete('{{ route('archive.forceDelete', ['type' => 'spare_part', 'id' => $item->id]) }}', this)"
