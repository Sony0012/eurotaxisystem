    ...
    <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">{{ $expense->deleted_at->format('M d, Y H:i') }}</td>
                <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                    ...
                    <form action="{{ route('archive.forceDelete', ['type' => 'expense', 'id' => $expense->id]) }}" method="POST" class="inline-block" onsubmit="return confirm('Are you sure you want to permanently delete this expense?')">
                        @csrf
                        @method('DELETE')
            ...
            @empty
            <tr>
                <td colspan="5" class="px-6 py-10 text-center text-gray-500">No archived expenses found.</td>
            </tr>
            @endforelse
        </tbody>
    </table>
