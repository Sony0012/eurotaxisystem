<div class="overflow-x-auto w-full">
    <table class="w-full divide-y divide-slate-100">
        <thead class="bg-slate-50/70">
            <tr>
                <th class="px-6 sm:px-8 py-4 text-left text-xs font-black text-slate-400 uppercase tracking-widest">Category</th>
                <th class="px-6 sm:px-8 py-4 text-left text-xs font-black text-slate-400 uppercase tracking-widest">Amount</th>
                <th class="px-6 sm:px-8 py-4 text-left text-xs font-black text-slate-400 uppercase tracking-widest">Expense Date</th>
        ...
        <tbody class="bg-white divide-y divide-slate-100">
            ...
            <tr class="hover:bg-slate-50/80 transition-colors">
                ...
                <td class="px-6 sm:px-8 py-5 whitespace-nowrap text-sm font-black text-rose-600">
