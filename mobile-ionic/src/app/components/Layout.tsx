    ...
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="flex flex-col flex-grow pt-5 overflow-y-auto">
          <div className="flex items-center flex-shrink-0 px-4">
                  ...
                  <span className="ml-2 text-xl font-bold text-white tracking-tight">
                    <span className="text-yellow-400">Euro</span>taxi
                  </span>
          </div>
          <nav className="mt-8 flex-1 px-2 space-y-1">
            ...
            <button
              ...
              className="group flex items-center px-3 py-2 text-sm rounded-md transition-colors text-gray-300 hover:bg-gray-800 hover:text-white"
            >
      ...
      {sidebarOpen && (
        <>
          ...
          />
          <aside className="fixed inset-y-0 left-0 flex flex-col w-64 bg-gray-900 z-30 lg:hidden">
            <div className="flex flex-col flex-grow pt-5 overflow-y-auto">
              ...
              <nav className="mt-8 flex-1 px-2 space-y-1">
                {renderNavLinks(filteredNavItems, () => setSidebarOpen(false))}
                <button
                  onClick={handleLogout}
                  className="group flex items-center px-3 py-2 text-sm rounded-md transition-colors text-gray-300 hover:bg-gray-800 hover:text-white"
                >
      ...
      <div className="lg:pl-64 flex flex-col flex-1">
        <div className="sticky top-0 z-10 flex-shrink-0 flex h-16 bg-white shadow">
          <button
            type="button"
            className="px-4 text-gray-500 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-yellow-500 lg:hidden"
            onClick={() => setSidebarOpen(true)}
          >
            <Menu className="h-6 w-6" />
          </button>
          <div className="flex-1 px-4 flex items-center justify-between">
            <h1 className="text-xl font-bold text-gray-900">Euro Fleet Management</h1>
