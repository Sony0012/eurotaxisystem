...
class DriverManagementController extends Controller
{
    ...
    public function show($id)
    {
        ...
        $assignedUnit = DB::table('units')
            ...
            ->whereNull('deleted_at')
            ->select('id', 'uuid', 'driver_id', 'secondary_driver_id', 'plate_number')
            ->first();
    ...
    {
        $driver_instance = Driver::where('uuid', $id)->firstOrFail();
    ...
    {
        $driver = Driver::where('uuid', $id)->first();
        if ($driver) {
    ...
    public function banned(Request $request)
    {
        ...
        $activeDrivers = DB::table('drivers')
            ...
            ->select('id', 'uuid', 'first_name', 'last_name', 'driver_status',
    ...
    {
        $driver = Driver::where('uuid', $id)->firstOrFail();
