...
class DashboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Note: Global System Alerts (Coding, Missing Units, Expiring Franchise) 
        // are now automatically generated and maintained via AppServiceProvider 
        // to ensure they are available on every page load.
