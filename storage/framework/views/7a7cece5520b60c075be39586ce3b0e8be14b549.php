                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                ...
                                <div class="text-[10px] text-gray-400 mt-1">
                                    <span title="Input by <?php echo e($expense->creator_name ?? 'System'); ?>">In: <?php echo e($expense->creator_name ?? 'System'); ?></span>
                                    <?php if(isset($expense->editor_name) && $expense->editor_name): ?>
                                        <span class="ml-1" title="Last edit by <?php echo e($expense->editor_name); ?>">Ed: <?php echo e($expense->editor_name); ?></span>
                                    <?php endif; ?>
                                </div>
                            </td>
