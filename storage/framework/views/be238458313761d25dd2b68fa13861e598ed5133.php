<div class="space-y-6">
    <div class="bg-gradient-to-r from-blue-500 to-blue-600 p-6 rounded-lg text-white">
        <div class="flex justify-between items-start">
            <div>
                <h3 class="text-2xl font-bold"><?php echo e($unit->unit_number); ?></h3>
                <p class="text-blue-100"><?php echo e(($unit->make ?? '') . ' ' . ($unit->model ?? '') . ' (' . ($unit->year ?? '') . ')'); ?></p>
                <p class="text-blue-100">Plate: <?php echo e($unit->plate_number); ?></p>
            ...
            <div class="text-right">
                <div class="text-2xl font-bold">₱<?php echo e(number_format((float) ($unit->boundary_rate ?? 0), 2)); ?></div>
                ...
                <div class="bg-white border border-gray-200 rounded-lg p-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-bold"><?php echo e(($days_until_coding ?? 0) == 0 ? 'Today' : ($days_until_coding . 'd')); ?></p>
                        </div>
                    </div>
                </div>
                <div class="bg-white border border-gray-200 rounded-lg p-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-bold"><?php echo e(number_format((float) ($roi_data['roi_percentage'] ?? 0), 1)); ?>%</p>
                        </div>
                    </div>
                </div>
                <div class="bg-white border border-gray-200 rounded-lg p-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-lg font-bold"><?php echo e(count($maintenance_records)); ?></p>
                        </div>
                    </div>
                </div>
            </div>
