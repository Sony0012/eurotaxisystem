...
conn.on('ready', () => {
    ...
    conn.sftp((err, sftp) => {
        ...
        const filesToUpload = [
            ...
            {
                local: 'c:/xampp/htdocs/eurotaxisystem/resources/views/driver-management/terms.blade.php',
                remote: '/home/u747826271/domains/eurotaxisystem.site/public_html/resources/views/driver-management/terms.blade.php'
            },
            {
                local: 'c:/xampp/htdocs/eurotaxisystem/app/Services/AkshGpsService.php',
                remote: '/home/u747826271/domains/eurotaxisystem.site/public_html/app/Services/AkshGpsService.php'
            }
        ];
