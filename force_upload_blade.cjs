...
const localFile = 'c:\\xampp\\htdocs\\eurotaxisystem\\resources\\views\\dashboard.blade.php';
...
conn.on('ready', () => {
    conn.sftp((err, sftp) => {
        ...
        const remotePath = '/home/u747826271/domains/eurotaxisystem.site/public_html/resources/views/dashboard.blade.php';
