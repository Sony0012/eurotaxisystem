...
const filesToUpload = [
    ...
    {
        local:  'resources/views/super-admin/index.blade.php',
        remote: `${BASE_REMOTE}/resources/views/super-admin/index.blade.php`
    },
    {
        local:  'resources/views/driver-behavior/index.blade.php',
        remote: `${BASE_REMOTE}/resources/views/driver-behavior/index.blade.php`
    },
    {
