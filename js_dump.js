...
function renderUnits(units, statusColors, statusIcons, statusGradients) {
            ...
            grid.innerHTML = units.map(unit => {
                ...
                return `
                <div class="${cardStyle} rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 relative group overflow-hidden hover:-translate-y-0.5">
            ...
            <div class="bg-gray-50 p-4 border-b border-gray-200 flex-shrink-0 print-section overflow-y-auto max-h-[85vh]">
                <div class="max-w-5xl mx-auto bg-white border border-gray-200 rounded-xl p-6 shadow-sm relative" id="incomeReport">
                    ...
                    <div class="text-center mb-10 print-only">
                        ...
                        <div class="text-[12px] text-gray-400 mt-3 font-bold tracking-[0.2em]">EURO TAXI MANAGEMENT SYSTEM â€¢ OFFICIAL RECORD</div>
                    ...
                    <div class="mb-6">
                        <div class="flex justify-between items-center bg-gray-900 text-white px-6 py-3 rounded-t-lg">
                            ...
                            <span class="text-xl font-black text-emerald-400" id="reportTotalIncome">â‚±0.00</span>
                        </div>
                    ...
                    <div class="mb-6">
                        <div class="flex justify-between items-center bg-red-900 text-white px-6 py-3 rounded-t-lg">
                            ...
                            <span class="text-xl font-black text-red-300" id="reportTotalExpenses">â‚±0.00</span>
                        </div>
                        <div class="border-x border-b border-gray-100 rounded-b-lg p-0">
                            ...
                            <div class="border-b border-gray-100">
                                <div class="bg-gray-50 px-6 py-1 border-b border-gray-100 flex justify-between text-[9px] font-black text-gray-400 uppercase tracking-widest">
                                    ...
                                    <span id="reportMaintenanceTotal" class="text-orange-600 font-black">Total: â‚±0.00</span>
                                </div>
                            ...
                            <div>
                                <div class="bg-gray-50 px-6 py-1 border-b border-gray-100 flex justify-between text-[9px] font-black text-gray-400 uppercase tracking-widest">
                                    ...
                                    <span id="reportGeneralExpensesTotal" class="text-red-500 font-black">Total: â‚±0.00</span>
                                </div>
            ...
            <div class="bg-gray-50 p-4 border-b border-gray-200 flex-shrink-0 print-section overflow-y-auto max-h-[85vh]">
                <div class="max-w-5xl mx-auto bg-white border border-gray-200 rounded-xl p-6 shadow-sm relative" id="expensesReport">
                    ...
                    <div class="text-center mb-10 print-only">
                        ...
                        <div class="text-[12px] text-gray-400 mt-3 font-bold tracking-[0.2em]">EURO TAXI MANAGEMENT SYSTEM â€¢ OFFICIAL EXPENSE RECORD</div>
                        <div class="border-t-2 border-gray-100 mt-8 pt-2 h-0 border-dashed"></div>
                    </div>
                    ...
                    <div class="mb-6">
                        <div class="flex justify-between items-center bg-red-900 text-white px-6 py-3 rounded-t-lg">
                            ...
                            <span class="text-xl font-black text-red-300" id="expensesTotalValue">â‚±0.00</span>
                        </div>
                        <div class="border-x border-b border-gray-100 rounded-b-lg p-0">
                            <!-- Maintenance Breakdown -->
                            <div class="border-b border-gray-100">
                                <div class="bg-gray-50 px-6 py-1 border-b border-gray-100 flex justify-between text-[9px] font-black text-gray-400 uppercase tracking-widest">
                                    <span>Maintenance & Repairs Itemized</span>
                                    <span id="expensesMaintenanceTotal" class="text-orange-600 font-black text-[10px]">Total: â‚±0.00</span>
                                </div>
                            ...
                            <div>
                                <div class="bg-gray-50 px-6 py-1 border-b border-gray-100 flex justify-between text-[9px] font-black text-gray-400 uppercase tracking-widest">
                                    <span>General Office Expenses Itemized</span>
                                    <span id="expensesOfficeTotal" class="text-red-500 font-black text-[10px]">Total: â‚±0.00</span>
                                </div>
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                    ...
                    <div class="bg-white rounded-lg p-3 shadow-sm border border-green-100 hover:shadow-md transition-shadow">
                        <div class="flex items-center gap-2">
                            ...
                            <div>
                                <div class="text-lg font-bold text-blue-600" id="uniqueUnitsCount">â‚±0</div>
                    ...
                    <div class="bg-white rounded-lg p-3 shadow-sm border border-green-100 hover:shadow-md transition-shadow">
                        <div class="flex items-center gap-2">
                            ...
                            <div>
                                <div class="text-lg font-bold text-purple-600" id="uniqueDriversCount">â‚±0</div>
                    ...
                    <div class="bg-white rounded-lg p-3 shadow-sm border border-green-100 hover:shadow-md transition-shadow">
                        <div class="flex items-center gap-2">
                            ...
                            <div>
                                <div class="text-lg font-bold text-yellow-600" id="totalBoundaryAmount">â‚±0</div>
    ...
    <div id="unitsModal" class="hidden fixed inset-0 bg-black bg-opacity-60 z-50 flex items-center justify-center p-4 backdrop-blur-sm">
        <div class="bg-white rounded-2xl shadow-2xl max-w-7xl w-full mx-4 h-[95vh] flex flex-col border border-gray-100">
            ...
            <div class="flex-1 overflow-hidden flex flex-col min-h-0">
                ...
                <div class="bg-gradient-to-r from-slate-50 to-indigo-50/30 p-4 border-b border-gray-200/60 flex-shrink-0">
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div class="bg-white rounded-xl p-3 shadow-sm border border-gray-100/50 hover:shadow-lg transition-all duration-300 group hover:-translate-y-0.5">
                            <div class="flex items-center gap-3">
                                <div class="p-2.5 bg-gradient-to-br from-blue-50 to-blue-100/80 rounded-lg group-hover:scale-110 transition-transform duration-300 border border-blue-100/50">
                                    <i data-lucide="car" class="w-5 h-5 text-blue-600"></i>
                                </div>
                                <div class="flex-1 min-w-0">
                                    <div class="text-xl font-black text-slate-800 leading-tight truncate" id="totalUnitsCount">0</div>
                                    <div class="text-[9px] text-slate-500 uppercase tracking-widest font-bold mt-1 truncate">Total Units</div>
                                </div>
                            </div>
                        </div>
                        <div class="bg-white rounded-xl p-3 shadow-sm border border-gray-100/50 hover:shadow-lg transition-all duration-300 group hover:-translate-y-0.5">
                            <div class="flex items-center gap-3">
                                <div class="p-2.5 bg-gradient-to-br from-gray-50 to-gray-200/80 rounded-lg group-hover:scale-110 transition-transform duration-300 border border-gray-200/50">
                                    <i data-lucide="user-x" class="w-5 h-5 text-gray-500"></i>
                                </div>
                                <div class="flex-1 min-w-0">
                                    <div class="text-xl font-black text-slate-800 leading-tight truncate" id="activeUnitsCount">0</div>
                                    <div class="text-[9px] text-slate-500 uppercase tracking-widest font-bold mt-1 truncate">Vacant (No Driver)</div>
                                </div>
                            </div>
                        </div>
                        <div class="bg-white rounded-xl p-3 shadow-sm border border-gray-100/50 hover:shadow-lg transition-all duration-300 group hover:-translate-y-0.5">
                            <div class="flex items-center gap-3">
                                <div class="p-2.5 bg-gradient-to-br from-green-50 to-emerald-100/80 rounded-lg group-hover:scale-110 transition-transform duration-300 border border-green-200/50">
                                    <i data-lucide="activity" class="w-5 h-5 text-green-600"></i>
                                </div>
                                <div class="flex-1 min-w-0">
                                    <div class="text-xl font-black text-slate-800 leading-tight truncate" id="roiUnitsCount">0</div>
                                    <div class="text-[9px] text-slate-500 uppercase tracking-widest font-bold mt-1 truncate">Active (W/ Driver)</div>
                                </div>
                            </div>
                        </div>
                        <div class="bg-white rounded-xl p-3 shadow-sm border border-gray-100/50 hover:shadow-lg transition-all duration-300 group hover:-translate-y-0.5">
                            <div class="flex items-center gap-3">
                                <div class="p-2.5 bg-gradient-to-br from-purple-50 to-purple-100/80 rounded-lg group-hover:scale-110 transition-transform duration-300 border border-purple-200/50">
                                    <i data-lucide="pie-chart" class="w-5 h-5 text-purple-600"></i>
                                </div>
                                <div class="flex-1 min-w-0">
                                    <div class="text-xl font-black text-slate-800 leading-tight truncate" id="avgRoiCount">0%</div>
                                    <div class="text-[9px] text-slate-500 uppercase tracking-widest font-bold mt-1 truncate">Avg ROI</div>
                                </div>
                            </div>
                        </div>
                    </div>
