...
@push('styles')
    <style>
        ...
        .card-hover::after {
            content: '';
            position: absolute;
            bottom: -5px; /* slight overflow to hide bottom edge */
            right: -5px;
            width: 75%;
            height: 55px; /* height of the chart */
        ...
        .wave-cyan::after { background-image: url('data:image/svg+xml;utf8,<svg viewBox="0 0 100 50" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg"><polygon fill="rgba(6,182,212,0.15)" stroke="rgba(6,182,212,0.4)" stroke-width="1.5" vector-effect="non-scaling-stroke" stroke-linejoin="miter" points="0,50 0,35 15,20 30,30 45,10 60,25 75,5 90,15 100,0 100,50" /></svg>'); }
...
@section('content')
    ...
    <div class="grid grid-cols-2 gap-3 sm:gap-5 md:grid-cols-2 lg:grid-cols-4">
        ...
        {{-- Total Units --}}
        <div onclick="showUnitsModal()" class="card-hover wave-blue cursor-pointer group relative overflow-hidden bg-white rounded-2xl shadow-md shadow-slate-200/40 ring-1 ring-slate-900/5 p-4 sm:p-5 flex flex-col justify-between" style="min-height: 130px;">
            <div class="relative z-20 flex items-start gap-3 sm:gap-4">
                <div class="w-10 h-10 sm:w-12 sm:h-12 bg-blue-50 rounded-[14px] flex items-center justify-center flex-shrink-0">
                    <i data-lucide="truck" class="w-5 h-5 sm:w-6 sm:h-6 text-blue-600"></i>
                </div>
                <div class="flex flex-col pt-0.5">
                    <p class="text-blue-600 text-[11px] sm:text-xs font-bold mb-0.5">Total Units</p>
                    <p class="text-slate-800 text-2xl sm:text-3xl font-bold tracking-tight leading-none mb-1" data-stat="active_units">{{ $stats['active_units'] }}</p>
                    <p class="text-slate-500 text-[9px] sm:text-[10px] font-medium">Active Vehicles</p>
                </div>
            </div>
            <div class="relative z-20 mt-4 flex items-end justify-between">
                <div class="flex flex-col">
                    <span class="text-blue-600 text-xs sm:text-sm font-bold flex items-center gap-1">
                        <i data-lucide="triangle" class="w-3 h-3 fill-current"></i> 8%
                    </span>
                    <span class="text-slate-400 text-[8px] sm:text-[9px] font-medium mt-0.5">vs last month</span>
                </div>
            </div>
        </div>

        {{-- Daily Boundary Collection --}}
        <div onclick="showDailyBoundaryModal()" class="card-hover wave-emerald cursor-pointer group relative overflow-hidden bg-white rounded-2xl shadow-md shadow-slate-200/40 ring-1 ring-slate-900/5 p-4 sm:p-5 flex flex-col justify-between" style="min-height: 130px;">
            <div class="relative z-20 flex items-start gap-3 sm:gap-4">
                <div class="w-10 h-10 sm:w-12 sm:h-12 bg-emerald-50 rounded-[14px] flex items-center justify-center flex-shrink-0">
                    <i data-lucide="wallet" class="w-5 h-5 sm:w-6 sm:h-6 text-emerald-600"></i>
                </div>
                <div class="flex flex-col pt-0.5">
                    <p class="text-emerald-500 text-[11px] sm:text-xs font-bold mb-0.5">Boundary Revenue</p>
                    <p class="text-slate-800 text-xl sm:text-2xl font-bold tracking-tight leading-none mb-1" data-stat="today_boundary">{{ formatCurrency($stats['today_boundary']) }}</p>
                    <p class="text-slate-500 text-[9px] sm:text-[10px] font-medium">This Month</p>
                </div>
            </div>
            <div class="relative z-20 mt-4 flex items-end justify-between">
                <div class="flex flex-col">
                    <span class="text-emerald-600 text-xs sm:text-sm font-bold flex items-center gap-1">
                        <i data-lucide="triangle" class="w-3 h-3 fill-current"></i> 12%
                    </span>
                    <span class="text-slate-400 text-[8px] sm:text-[9px] font-medium mt-0.5">vs last month</span>
                </div>
            </div>
        ...
        {{-- Net Income --}}
        <div onclick="showNetIncomeModal()" class="card-hover wave-cyan cursor-pointer group relative overflow-hidden bg-white rounded-2xl shadow-md shadow-slate-200/40 ring-1 ring-slate-900/5 p-4 sm:p-5 flex flex-col justify-between" style="min-height: 130px;">
            <div class="relative z-20 flex items-start gap-3 sm:gap-4">
                <div class="w-10 h-10 sm:w-12 sm:h-12 bg-cyan-50 rounded-[14px] flex items-center justify-center flex-shrink-0">
                    <i data-lucide="trending-up" class="w-5 h-5 sm:w-6 sm:h-6 text-cyan-600"></i>
                </div>
                <div class="flex flex-col pt-0.5">
                    <p class="text-cyan-500 text-[11px] sm:text-xs font-bold mb-0.5">Net Income (KITA)</p>
                    <p class="text-slate-800 text-xl sm:text-2xl font-bold tracking-tight leading-none mb-1" data-stat="net_income">{{ formatCurrency($stats['net_income']) }}</p>
                    <p class="text-slate-500 text-[9px] sm:text-[10px] font-medium">This Month</p>
                </div>
            </div>
            <div class="relative z-20 mt-4 flex items-end justify-between">
                <div class="flex flex-col">
                    <span class="text-cyan-600 text-xs sm:text-sm font-bold flex items-center gap-1">
                        <i data-lucide="triangle" class="w-3 h-3 fill-current"></i> 15%
                    </span>
                    <span class="text-slate-400 text-[8px] sm:text-[9px] font-medium mt-0.5">vs last month</span>
                </div>
            </div>
        ...
        <div onclick="showMaintenanceUnitsModal()" class="card-hover wave-orange cursor-pointer group relative overflow-hidden bg-white rounded-2xl shadow-md shadow-slate-200/40 ring-1 ring-slate-900/5 p-4 sm:p-5 flex flex-col justify-between" style="min-height: 130px;">
            <div class="relative z-20 flex items-start gap-3 sm:gap-4">
                <div class="w-10 h-10 sm:w-12 sm:h-12 bg-orange-50 rounded-[14px] flex items-center justify-center flex-shrink-0">
                    <i data-lucide="wrench" class="w-5 h-5 sm:w-6 sm:h-6 text-orange-500"></i>
                </div>
                <div class="flex flex-col pt-0.5">
                    <p class="text-orange-500 text-[11px] sm:text-xs font-bold mb-0.5">Under Maintenance</p>
                    <p class="text-slate-800 text-2xl sm:text-3xl font-bold tracking-tight leading-none mb-1" data-stat="maintenance_units">{{ $stats['maintenance_units'] }}</p>
                    <p class="text-slate-500 text-[9px] sm:text-[10px] font-medium">Ongoing Units</p>
                </div>
            </div>
            <div class="relative z-20 mt-4 flex items-end justify-between">
                <div class="flex flex-col">
                    <span class="text-red-500 text-xs sm:text-sm font-bold flex items-center gap-1">
                        <i data-lucide="triangle" class="w-3 h-3 fill-current rotate-180"></i> 20%
                    </span>
                    <span class="text-slate-400 text-[8px] sm:text-[9px] font-medium mt-0.5">vs last month</span>
                </div>
            </div>
    ...
    <div class="mt-4 grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
        ...
        {{-- Active Drivers --}}
        <div onclick="showActiveDriversModal()" class="card-hover wave-indigo cursor-pointer group relative overflow-hidden rounded-2xl shadow-md shadow-slate-200/40 ring-1 ring-indigo-900/5 bg-gradient-to-br from-indigo-50 to-violet-50/70">
            
            <div class="relative p-3.5 sm:p-5 flex items-center justify-between z-20">
                <div class="flex-1 min-w-0">
                    <p class="text-indigo-400 text-[9px] sm:text-[10px] font-bold uppercase tracking-widest mb-1">Active Drivers</p>
                ...
                <div class="p-1.5 sm:p-3 bg-indigo-100 rounded-xl sm:rounded-2xl border border-indigo-200 shadow-md shadow-slate-200/40 flex-shrink-0">
        ...
        <div onclick="showExpensesModal()" class="card-hover wave-rose cursor-pointer group relative overflow-hidden rounded-2xl shadow-md shadow-slate-200/40 ring-1 ring-rose-900/5 bg-gradient-to-br from-rose-50 to-red-50/70">
            
            <div class="relative p-3.5 sm:p-5 flex items-center justify-between z-20">
                <div class="flex-1 min-w-0">
                    <p class="text-rose-400 text-[9px] sm:text-[10px] font-bold uppercase tracking-widest mb-1">Expenses Today</p>
                ...
                <div class="p-1.5 sm:p-3 bg-rose-100 rounded-xl sm:rounded-2xl border border-rose-200 shadow-md shadow-slate-200/40 flex-shrink-0">
        ...
        {{-- Coding Units Today --}}
        <div onclick="showCodingUnitsModal()" class="col-span-2 lg:col-span-1 card-hover wave-violet cursor-pointer group relative overflow-hidden rounded-2xl shadow-md shadow-slate-200/40 ring-1 ring-violet-900/5 bg-gradient-to-br from-violet-50 to-purple-50/70">
            
            <div class="relative p-3.5 sm:p-5 flex items-center justify-between z-20">
                <div class="flex-1 min-w-0">
                    <p class="text-violet-400 text-[9px] sm:text-[10px] font-bold uppercase tracking-widest mb-1">Coding Units Today</p>
                ...
                <div class="p-1.5 sm:p-3 bg-violet-100 rounded-xl sm:rounded-2xl border border-violet-200 shadow-md shadow-slate-200/40 flex-shrink-0">
    ...
    <div class="mt-4 bg-white rounded-lg shadow-lg ring-1 ring-slate-900/5 overflow-hidden">
