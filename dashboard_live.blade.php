...
@section('content')
    ...
    <div class="grid grid-cols-2 gap-3 sm:gap-5 md:grid-cols-2 lg:grid-cols-4">
        ...
        {{-- Total Units --}}
        <div onclick="showUnitsModal()" class="card-hover wave-blue cursor-pointer group relative overflow-hidden bg-white rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-5 flex flex-col justify-between" style="min-height: 130px;">
            <div class="relative z-20 flex items-start gap-3 sm:gap-4">
                ...
                <div class="flex flex-col pt-0.5">
                    ...
                    <p class="text-gray-900 text-2xl sm:text-3xl font-black leading-none mb-1" data-stat="active_units">{{ $stats['active_units'] }}</p>
                    <p class="text-gray-500 text-[9px] sm:text-[10px] font-medium">Active Vehicles</p>
                </div>
            </div>
            <div class="relative z-20 mt-4 flex items-end justify-between">
                <div class="flex flex-col">
                    ...
                    <span class="text-gray-400 text-[8px] sm:text-[9px] font-medium mt-0.5">vs last month</span>
                </div>
            </div>
        </div>

        {{-- Daily Boundary Collection --}}
        <div onclick="showDailyBoundaryModal()" class="card-hover wave-emerald cursor-pointer group relative overflow-hidden bg-white rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-5 flex flex-col justify-between" style="min-height: 130px;">
            <div class="relative z-20 flex items-start gap-3 sm:gap-4">
                ...
                <div class="flex flex-col pt-0.5">
                    ...
                    <p class="text-gray-900 text-xl sm:text-2xl font-black leading-none mb-1" data-stat="today_boundary">{{ formatCurrency($stats['today_boundary']) }}</p>
                    <p class="text-gray-500 text-[9px] sm:text-[10px] font-medium">This Month</p>
                </div>
            </div>
            <div class="relative z-20 mt-4 flex items-end justify-between">
                <div class="flex flex-col">
                    <span class="text-emerald-600 text-xs sm:text-sm font-black flex items-center gap-1">
        ...
        {{-- Net Income --}}
        <div onclick="showNetIncomeModal()" class="card-hover wave-cyan cursor-pointer group relative overflow-hidden bg-white rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-5 flex flex-col justify-between" style="min-height: 130px;">
            <div class="relative z-20 flex items-start gap-3 sm:gap-4">
                ...
                <div class="flex flex-col pt-0.5">
                    ...
                    <p class="text-gray-900 text-xl sm:text-2xl font-black leading-none mb-1" data-stat="net_income">{{ formatCurrency($stats['net_income']) }}</p>
                    <p class="text-gray-500 text-[9px] sm:text-[10px] font-medium">This Month</p>
                </div>
            </div>
            <div class="relative z-20 mt-4 flex items-end justify-between">
                <div class="flex flex-col">
                    <span class="text-cyan-600 text-xs sm:text-sm font-black flex items-center gap-1">
        ...
        <div onclick="showMaintenanceUnitsModal()" class="card-hover wave-orange cursor-pointer group relative overflow-hidden bg-white rounded-2xl shadow-sm border border-gray-100 p-4 sm:p-5 flex flex-col justify-between" style="min-height: 130px;">
            <div class="relative z-20 flex items-start gap-3 sm:gap-4">
                ...
                <div class="flex flex-col pt-0.5">
                    ...
                    <p class="text-gray-900 text-2xl sm:text-3xl font-black leading-none mb-1" data-stat="maintenance_units">{{ $stats['maintenance_units'] }}</p>
                    <p class="text-gray-500 text-[9px] sm:text-[10px] font-medium">Ongoing Units</p>
                </div>
            </div>
            <div class="relative z-20 mt-4 flex items-end justify-between">
                <div class="flex flex-col">
                    <span class="text-red-500 text-xs sm:text-sm font-black flex items-center gap-1">
